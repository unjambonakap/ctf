...
import random
from utils import inverse_mod, next_prime, egcd
...
def main(argv):
  ...
  test = subparsers.add_parser("solve", description="decrypt a message")
  test.add_argument('pubkey_file', nargs="?", default="pubkey.txt")
  test.add_argument('density', nargs="?", type=float, default=0.9)
  test.set_defaults(cmd="solve")
