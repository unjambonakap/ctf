...
class des(_baseDes):
    ...
    __pc1 = [56, 48, 40, 32, 24, 16, 8, 0, 57, 49, 41, 33, 25, 17, 9, 1, 58, 50,
    ...
    __pc2 = [13, 16, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18, 11, 3, 25, 7,
             15, 6, 26, 19, 12, 1, 40, 51, 30, 36, 46, 54, 29, 39, 50, 44, 32,
             47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, 28, 31]

    # initial permutation IP
    __ip = [57, 49, 41, 33, 25, 17, 9, 1, 59, 51, 43, 35, 27, 19, 11, 3, 61, 53,
            45, 37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7, 56, 48, 40,
            32, 24, 16, 8, 0, 58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28,
            20, 12, 4, 62, 54, 46, 38, 30, 22, 14, 6]

    # Expansion table for turning 32 bit blocks into 48 bits
    __expansion_table = [31, 0, 1, 2, 3, 4, 3, 4, 5, 6, 7, 8, 7, 8, 9, 10, 11,
    ...
    __p = [15, 6, 19, 20, 28, 11, 27, 16, 0, 14, 22, 25, 4, 17, 30, 9, 1, 7, 23,
           13, 31, 26, 2, 8, 18, 12, 29, 5, 21, 10, 3, 24]

    # final permutation IP^-1
    __fp = [39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30, 37, 5,
    ...
    def __des_crypt(self, block, crypt_type):
        ...
        print(list(map(self.tsf, self.Kn)))
        i = 0
        while i < 16:
            ...
            while j < 8:
                ...
                Bn[pos + 2] = (v & 2) >> 1
                Bn[pos + 3] = v & 1
                print(self.tsf(B[j]), self.tsf(Bn[pos:pos+4]))
            ...
            print(self.tsf(tempR), self.tsf(self.R))
    ...
    def crypt(self, data, crypt_type):
        ...
        if len(data) % self.block_size != 0:
            ...
            if not self.getPadding():
                raise ValueError(
                    "Invalid data length, data must be a multiple of " + str(
                        self.block_size) +
