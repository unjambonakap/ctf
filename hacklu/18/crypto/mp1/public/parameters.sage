...
print(0xdead*P + 0xbeef * Q)
print((0xdead+79182553273022138539034276599687)*P + 0xbeef * Q)
print(E((542342417109300762922401936535663978, 726821508217691654812343977365180386)))
print(0xdeaf*P + 0xbeff * Q)
